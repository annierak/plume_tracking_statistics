...
#file info
file_name='plume_tracking_collector_small'
...
# print(source_pos)
# raw_input()
collector = TrackBoutCollector(swarm_size,wind_angle,source_pos)
...
plt.hist(failure_entry_distances,bins,alpha=0.5,label='failed',color='r')
plt.hist(success_entry_distances,bins,alpha=0.5,label='succeeded',color='b')
