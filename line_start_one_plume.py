...
swarm_param = {
            ...
            'heading_data'        : None,
            'initial_heading'     : np.radians(np.random.uniform(45.0,225.0,(swarm_size,))),
            'x_start_position'    : np.linspace(-arena_size+100,50,swarm_size),
            'y_start_position'    : np.linspace(-arena_size+100,50,swarm_size),
